...
const storeSection: SidebarSection = {
  ...
  nodes: [
    ...
    { kind: "link", key: "store-receive-items", name: "Receive Items", path: "/store/receive-items", icon: Truck },
    { kind: "link", key: "store-rate-approval", name: "Rate Approval", path: "/store/rate-approval", icon: BadgeCheck },
    { kind: "link", key: "store-vendor-update", name: "Vendor Update", path: "/store/vendor-update", icon: RefreshCw },
    ...
    { kind: "link", key: "store-repair-gate-pass-history", name: "Repair Gate Pass - History", path: "/store/repair-gate-pass/history", icon: Files },
