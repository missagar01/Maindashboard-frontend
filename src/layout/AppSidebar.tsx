...
const salesWorkspaceSection: SidebarSection = {
  ...
  nodes: [
    ...
    { kind: "link", key: "o2d-sales-fms", name: "Sales FMS", path: "/o2d/sales-fms", icon: GitBranch },
    ...
    { kind: "link", key: "o2d-crm-fms", name: "CRM FMS", path: "/o2d/crm-fms", icon: Receipt },
...
const checklistSection: SidebarSection = {
  ...
  nodes: [
    ...
    { kind: "link", key: "checklist-announcements", name: "Announcements", path: "/checklist/announcements", icon: Megaphone },
