    ...
    <>
          ...
          <>
            ...
            {currentData.map((gatePass) => {
              ...
              return (
                <div
                  key={gatePass.id}
                  className={`bg-white rounded-xl shadow-sm border border-gray-200 p-4 transition-all duration-300 relative group overflow-hidden ${
                    isClosing ? 'opacity-70 ring-2 ring-blue-500 bg-blue-50' : 'hover:shadow-md hover:border-blue-300'
                  }`}
                >
                  ...
                  <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide ${
                        gatePass.approval_status.toLowerCase() === "approved"
      ...
      {toast.show && (
        <div className="fixed bottom-6 right-6 z-50 flex justify-center animate-in slide-in-from-bottom-5 fade-in">
          <div className={`max-w-sm px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 border ${
            toast.type === "success" 
