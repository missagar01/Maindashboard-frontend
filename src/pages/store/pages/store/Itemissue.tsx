...
export default function Itemissue() {
  ...
  return (
    <div className="w-full space-y-4 px-0 py-2 sm:p-4 md:p-6 lg:p-8">
      <Heading heading="Item Issue" subtext="View material issue transactions (MS)">
      ...
      <div className="space-y-2 px-1.5 md:hidden">
        {loading ? (
          ...
          pageRows.map((row, index) => (
            <div
              key={`${row.vrno}-${row.itemCode}-${index}`}
            ...
            >
              ...
              <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-2.5">
                <MobileField label="Division" value={row.division} />
                <MobileField label="Requester" value={row.requester} />
                <MobileField label="Department" value={row.department} className="col-span-2" />
                <MobileField label="Item Code" value={row.itemCode} />
                <MobileField label="Item Name" value={row.itemName} className="col-span-2" />
                <MobileField label="Purpose" value={row.purpose || "No purpose specified"} className="col-span-2" />
              </div>
