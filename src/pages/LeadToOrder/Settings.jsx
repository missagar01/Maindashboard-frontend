...
const PAGE_ROUTES = {
  ...
  "STORE AND PURCHASE": [
    ...
    createPageOption("Receive Items", "Receive Items", "/store/receive-items", ["/store/receive-items"]),
    createPageOption("Rate Approval", "Rate Approval", "/store/rate-approval", ["/store/rate-approval"]),
    createPageOption("Vendor Update", "Vendor Update", "/store/vendor-update", ["/store/vendor-update"]),
    ...
    createPageOption("Repair Gate Pass - History", "Repair Gate Pass - History", "/store/repair-gate-pass/history", ["Repair Gate Pass History", "/store/repair-gate-pass/history"]),
