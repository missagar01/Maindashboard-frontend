...
import { fetchDocumentsNeedingRenewal, mapBackendToFrontend, BackendDocument } from '@/api/document/documentApi';
...
const DocumentRenewal = () => {
    ...
    const handleSaveEdit = async (doc: DocumentItem) => {
        try {
            const { updateDocument } = await import('@/api/document/documentApi');
