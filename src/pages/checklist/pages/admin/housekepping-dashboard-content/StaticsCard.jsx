...
export default function StatisticsCards({
  ...
  const { dashboardSummary: stats, dashboardDepartments: departments, loadingDashboard, error } = housekeepingState || {};
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      await fetchHousekeepingDashboardSummaryAction({
  ...
  }, [selectedDepartment, dashboardType, dateRange, fetchHousekeepingDashboardSummaryAction]);
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        await fetchHousekeepingDepartmentsAction();
      } catch (err) {
