...
const TRANSPORT_PAGE_SLUG_ROUTE_MAP: Record<string, string> = {
  ...
  transportdodporeport: "/transport/do-dpo-report",
  dodporeport: "/transport/do-dpo-report",
  doporeport: "/transport/do-dpo-report",
  transportinwardlrreport: "/transport/inward-lr-report",
  inwardlrreport: "/transport/inward-lr-report",
  inwardreport: "/transport/inward-lr-report",
  inwordreport: "/transport/inward-lr-report",
  invwordreport: "/transport/inward-lr-report",
  transportoutwardlrreport: "/transport/outward-lr-report",
...
export const PAGE_NAME_TO_ROUTE_MAP: Record<string, string> = {
  ...
  "Transport Handover": "/transport/handover",
  Handover: "/transport/handover",
  ...
  "Transport DO DPO Report": "/transport/do-dpo-report",
  "DO / DPO Report": "/transport/do-dpo-report",
  "DO / PO Report": "/transport/do-dpo-report",
  "Transport Inward LR Report": "/transport/inward-lr-report",
  "Inward LR Report": "/transport/inward-lr-report",
  "Inward Report": "/transport/inward-lr-report",
  "Inword Report": "/transport/inward-lr-report",
  "Invword Report": "/transport/inward-lr-report",
  "Transport Outward LR Report": "/transport/outward-lr-report",
